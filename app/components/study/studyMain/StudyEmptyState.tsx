...
export default function StudyEmptyState() {
  return (
    <div className="flex flex-col items-center justify-center h-full gap-8 pb-12">
      ...
      <Link href="/cards" className="flex items-center gap-1 px-5 py-3 bg-white border rounded-full cursor-pointer border-ink shadow-strong text-preset-4-medium hover:bg-background">
        Aller aux cartes
      </Link>
    </div>
  )
